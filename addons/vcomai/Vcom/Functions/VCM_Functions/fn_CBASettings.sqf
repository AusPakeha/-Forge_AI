	...
	*/
	...
	if (CBAACT) then
	{
		...
		[
			...
			"VCOM AI General Skills", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			false,// data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"CHECKBOX", // setting type
			"AI use additional idle animations. BROKEN do not use!", 
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			false,// data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,100,0,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,1000,20,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,2000,400,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			"VCM_HEARINGDISTANCE_SIL", // Internal setting name, should always contain a tag! This will be the global variable which takes the value of the setting.
			"SLIDER", // setting type
			"Distance AI can hear silenced weapons.", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,1000,80,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
				VCM_HEARINGDISTANCE_SIL = _value;
			} // function that will be executed once on mission start and every time the setting is changed.
		] call CBA_Settings_fnc_init;
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,5000,1000,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
				VCM_WARNDIST = _value;
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,500,30,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,500,120,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,5000,40,0], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[2,10,2,0], // data for this setting: [min, max, default, number of shown trailing decimals]
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{  
				params ["_value"];
		...
		*/
		...
		[
			...
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,100,20,2], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{
				params ["_value"];
		...
		[
			...
			"VCOM AI General Skills", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			[0,1000,40,2], // data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{
				params ["_value"];
		...
		[
			...
			"CHECKBOX", // setting type
			"Enable use of empty Static Weapons", // Pretty name shown inside the ingame settings menu. Can be stringtable entry.
			"VCOM SETTINGS", // Pretty name of the category where the setting can be found. Can be stringtable entry.
			true,// data for this setting:
			true, // "_isGlobal" flag. Set this to true to always have this setting synchronized between all clients in multiplayer
			{
		...
		//Garrison when idle toggle
		[
            "VCM_GarrisonIdle",            // internal variable name
            "CHECKBOX",                    // UI control type
            ["Garrison Idle Groups","Allow idle infantry groups to garrison nearby buildings"], // label + tooltip
            "VCOM SETTINGS2",                     // category
            true,                         // default value
            true                           // isGlobal
        ] call CBA_Settings_fnc_init;
		
		//Reinforcement setings
		[
            "VCM_Reinf_Ratio",
            "SLIDER",
            ["Reinforcements call-help ratio", "Enemy vs. friendly ratio required to call reinforcements."],
            "VCOM SETTINGS2",
            [0.5, 5, 2, 2],   // min, max, default, precision
            true
        ] call CBA_Settings_fnc_init;
        ...
        [
            "VCM_Reinf_Radius",
            "SLIDER",
            ["Reinforcements presence radius", "Radius (m) to count nearby friendlies/enemies."],
            "VCOM SETTINGS2",
            [50, 1000, 150, 0],
            true
        ] call CBA_Settings_fnc_init;
        ...
        [
            "VCM_Reinf_MaxGroups",
            "SLIDER",
            ["Reinforcements squads", "Max groups to request for help."],
            "VCOM SETTINGS2",
            [1, 10, 2, 0],
            true
        ] call CBA_Settings_fnc_init;
        ...
        [
            "VCM_SHARE_Distance",
            "SLIDER",
            ["Voice Share Distance", "Max distance for leaders to share contacts. 0 for disable"],
            "VCOM SETTINGS2",
            [0, 800, 50, 0]   // min, max, default, decimal places
        ] call CBA_Settings_fnc_init;
		
		[
            "VCM_PlayerReinforce_Enable",
            "CHECKBOX",
            ["Enable Player Reinforcements", "Allow players to request AI reinforcements via hotkey"],
            "VCOM SETTINGS2",
		...
		[
            "Vcm_EnableStaticDeploy",
            "CHECKBOX",
            ["Enable static weapon unpacking", "If disabled, AI will not deploy static weapons"],
            "VCOM SETTINGS2",
            true
        ] call CBA_Settings_fnc_init;
        ...
        [
            "Vcm_EnableUAVDeploy",
            "CHECKBOX",
            ["Enable UAV unpacking", "If disabled, AI will not assemble or launch UAVs"],
            "VCOM SETTINGS2",
            true
        ] call CBA_Settings_fnc_init;
		
		[
            "VCM_HEARINGDISTANCE_EXP",            // internal var name
            "SLIDER",                             // control type
            "Explosion Hearing Distance",         // display name
            "VCOM SETTINGS2",                      // category
            [0, 2000, 400, 0], // [min, max, default, decimals]
            true,                                 // global
        {
            params ["_value"];
            VCM_HEARINGDISTANCE_EXP = _value;
        }
        ] call CBA_Settings_fnc_init;
		
		[
            "VCM_EXP_REACT_CHANCE",
            "SLIDER",
            ["Explosion investigation chance", "Chance that an explosion causes AI to investigate (0–1)."],
            "VCOM SETTINGS2",
            [0, 1, 0.3, 2],   // min, max, default, precision
            true,           // global
            { params ["_value"]; VCM_EXP_REACT_CHANCE = _value; }
        ] call CBA_Settings_fnc_init;
	
	    [
            "VCM_VEHREV_DIST",
            "SLIDER",
            ["Vehicle sensors helper dist","Will reveal nearby enemy based on sensors. Max distance."],
            "VCOM SETTINGS2",
            [0,2500,200,0],
            true
        ] call CBA_Settings_fnc_init;
        ...
        [
            "VCM_VEHREV_CHANCE",
            "SLIDER",
            ["Vehicle sensors base chance","Base chance to reveal with vehicle sensors."],
            "VCOM SETTINGS2",
            [0,100,50,0],
            true
        ] call CBA_Settings_fnc_init;
		...
		[
            "VCM_VEHREV_TIME",
            "SLIDER",
            ["Vehicle sensors loop time","How often (seconds) to check sensors for enemy"],
            "VCOM SETTINGS2",
            [10,500,50,0],
            true
        ] call CBA_Settings_fnc_init;
		...
		[
            "VCM_LIGHTDETECT_INFANTRY",
            "CHECKBOX",
            ["Detect infantry lasers/lights. ITN,WBK compat", "AI detect IR lasers. Also ITN,WBK compability for vis/IR flash detect"],
            "VCOM SETTINGS2",
            true
        ] call CBA_Settings_fnc_init;
