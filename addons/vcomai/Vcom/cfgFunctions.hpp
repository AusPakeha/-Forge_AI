class VCOM
{
	...
	class Functions 
	{
		...
		//[] call VCM_fnc_hasFarWaypoint;
		class hasFarWaypoint {};
		
		//[] call VCM_fnc_ShareContact;
		class ShareContact {};
		
		//[] call VCM_fnc_RequestReinforcement;
		class RequestReinforcement {};
		
		//[] call VCM_fnc_ExplosionHearing;
		class ExplosionHearing {};
		
		//[] call VCM_fnc_SupMove;
		class SupMove {};
		
		//[] call VCM_fnc_IsTurretOrArty;
		class IsTurretOrArty {};
		
		//[] call VCM_fnc_VehicleReveal;
		class VehicleReveal {};
		
		//[] call VCM_fnc_ITNDetect;
		class ITNDetect {};
	};		
